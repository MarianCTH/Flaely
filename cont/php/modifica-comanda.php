...
<?php
    ...
    if(isset($_GET['Cod']))
    {
        ...
        if(isset($_POST['update']))
        {
            ...
            if($query3)
            {
                echo "<script> window.location.href = '../materiale-furnizor.php'; </script>";
            }
        }
            ...
            <div class="wrap-login100" style="padding-top: 20px !important">
                <div class="col m-1">
                    <div class="text-center">
                        <h1 style="margin-bottom: 45px;">Modifică comanda materialului selectat</h1>
                    </div>
                    ...
                    <div class="text-center p-t-80">
                        <a class="txt2" href="../materiale-furnizor.php">
